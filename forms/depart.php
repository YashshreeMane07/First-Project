...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminLTE 4 | Department Form</title>
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content-top-area">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6"><div>Department Details</div></div>
              <div class="col-md-6 text-end">
                <a href="depart form.html" class="btn btn-primary" name="save" value="create">
                  Create Department
                  </a>
              </div>
            </div>
            ...
            echo "<tr id='row{$row['id']}'>
              ...
              <td>
                <button class='btn btn-warning btn-sm editBtn'
                  ...
                  data-dept_head='{$row['dept_head']}'
                  data-faculty_count='{$row['faculty_count']}'
    ...
    <div class="modal-content rounded-4">
      ...
      <form id="editForm">
        <div class="modal-body">
          ...
          <input type="text" name="dept_name" id="edit_dept_name" class="form-control mb-2" placeholder="Department Name" required>
          <input type="text" name="dept_head" id="edit_dept_head" class="form-control mb-2" placeholder="Head of Department" required>
          <input type="number" name="faculty_count" id="edit_faculty_count" class="form-control mb-2" placeholder="Faculty Count" required>
...
$(document).on("click", ".editBtn", function() {
  ...
  $("#edit_dept_head").val($(this).data("dept_head"));
  $("#edit_faculty_count").val($(this).data("faculty_count"));
...
$("#editForm").submit(function(e) {
  ...
  $.post("", {
    ...
    dept_name: $("#edit_dept_name").val(),
    dept_head: $("#edit_dept_head").val(),
    faculty_count: $("#edit_faculty_count").val(),
...
if (isset($_POST['update_id'])) {
  ...
  $conn->query("UPDATE department SET dept_name='$dept_name', dept_head='$dept_head', faculty_count='$faculty_count', email='$email', description='$description' WHERE id=$id");
  exit;
}
?>
