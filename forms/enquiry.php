...
<html lang="en">
  ...
  <head>
    ...
    <title>AdminLTE 4 | Enquiry Form</title>
    ...
    <div class="app-wrapper">
      ...
      <main class="app-main">
        ...
        <div class="app-content-top-area">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6"><div>Enquiry Details</div></div>
              <div class="col-md-6 text-end">
                <a href="enquiry form.html" class="btn btn-primary" name="save" value="create">
                  Create Enquiry
                  </a>
              </div>
            </div>
  ...
  <div class="card">
    ...
    <div class="table-responsive">
     <table id="enquiryTable" class="table table-bordered text-center align-middle">
        ...
        <thead>
          <tr>
            <th>ID</th><th>Name</th><th>Email</th><th>Phone</th><th>Course</th><th>Message</th><th>Actions</th>
          </tr>
        </thead>
        <tbody>
          <?php
            $res = $conn->query("SELECT * FROM enquiry");
    ...
    <div class="modal-content rounded-4">
      ...
      <form id="editForm">
        <div class="modal-body">
          ...
          <input type="text" name="phone" id="edit_phone" class="form-control mb-2" placeholder="Phone" required>
          <input type="text" name="course" id="edit_course" class="form-control mb-2" placeholder="Course" required>
          <textarea name="message" id="edit_message" class="form-control mb-2" placeholder="Message"></textarea>
        </div>
...
$("#confirmDelete").click(function() {
  $.post("", { delete_id: $("#delete_id").val() }, function(res) {
    location.reload();
  });
});
...
if (isset($_POST['update_id'])) {
  ...
  $conn->query("UPDATE enquiry SET name='$name', email='$email', phone='$phone', course='$course', message='$message' WHERE id=$id");
  exit;
}
?>
